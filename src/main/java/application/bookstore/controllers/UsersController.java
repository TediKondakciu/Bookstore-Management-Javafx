        ...
        usersView.getDeleteBtn().setOnAction(e->{
            ...
            for (User a: itemsToDelete) {
                if (a.deleteFromFile()) {
                    ...
                    usersView.getResultLabel().setText("Book removed successfully");
                    usersView.getResultLabel().setTextFill(Color.DARKGREEN);
                } else {
                    System.out.println("Book deletion failed username: "+a.getUsername());
                    usersView.getResultLabel().setText("Book deletion failed");
                    usersView.getResultLabel().setTextFill(Color.DARKRED);
                    break;
                }
            }
